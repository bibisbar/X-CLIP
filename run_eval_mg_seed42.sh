#!/bin/bash
#SBATCH --gres=gpu:1
#SBATCH --job-name mg_eval_seed42_xclip
#SBATCH -o mg_eval_seed42.out
#SBATCH -e mg_eval_seed42.err
...
do
    ...
    python -m torch.distributed.launch --nproc_per_node=1 --master_port 53678 \

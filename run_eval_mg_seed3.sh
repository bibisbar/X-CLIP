#!/bin/bash
#SBATCH --gres=gpu:1
#SBATCH --job-name mg_eval_seed3_xclip
#SBATCH -o mg_eval_seed3.out
#SBATCH -e mg_eval_seed3.err
...
do
    ...
    python -m torch.distributed.launch --nproc_per_node=1 --master_port 53677 \
    ...
    --init_model /home/wiss/zhang/nfs/video_prober/xclip/mg_train2_seed3/pytorch_model.bin.9 \

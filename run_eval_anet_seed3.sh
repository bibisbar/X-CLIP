#!/bin/bash
#SBATCH --gres=gpu:1
#SBATCH --job-name anet_eval_seed3
#SBATCH -o anet_eval_seed3.out
#SBATCH -e anet_eval_seed3.err
...
do
    ...
    python -m torch.distributed.launch --nproc_per_node=1 --master_port 22223 \
    ...
    --output_dir /home/wiss/zhang/nfs/Mg_ckpt/anet_eval_seed3/ \
    ...
    --init_model /home/wiss/zhang/nfs/video_prober/xclip/anet_train3_seed3/pytorch_model.bin.1 \

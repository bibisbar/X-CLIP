#!/bin/bash
#SBATCH --gres=gpu:1
#SBATCH --job-name anet_eval_seed2
#SBATCH -o anet_eval_seed2.out
#SBATCH -e anet_eval_seed2.err
...
do
    ...
    python -m torch.distributed.launch --nproc_per_node=1 --master_port 22224 \
    ...
    --output_dir /home/wiss/zhang/nfs/Mg_ckpt/anet_eval_seed2/ \

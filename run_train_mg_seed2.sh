#!/bin/bash
#SBATCH --gres=gpu:2
#SBATCH --job-name mg_train1_seed2 
#SBATCH -o mg_train1_seed2.out
#SBATCH -e mg_train1_seed2.err
...
python -m torch.distributed.launch --nproc_per_node=2 --master_port 11303 \
    ...
    --output_dir /home/wiss/zhang/nfs/video_prober/xclip/mg_train1_seed2 \
    ...
    --manipulation mg_train1_seed2  \
    --scale 0 \
    --dataset_ckpt mg_train1_seed2 \

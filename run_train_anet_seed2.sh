#!/bin/bash
#SBATCH --gres=gpu:2
#SBATCH --job-name anet_train2_seed2
#SBATCH -o anet_train2_seed2_continue.out
#SBATCH -e anet_train2_seed2_continue.err
...
python -m torch.distributed.launch --nproc_per_node=2 --master_port 11403 \
    ...
    --output_dir /home/wiss/zhang/nfs/video_prober/xclip/anet_train2_seed2_continue \
    ...
    --init_model /home/wiss/zhang/nfs/video_prober/xclip/anet_train2_seed2/pytorch_model.bin.2 \
    --manipulation anet_train2_seed2  \
    --scale 0 \
    --dataset_ckpt anet_train2_seed2 \

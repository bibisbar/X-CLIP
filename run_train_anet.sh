#!/bin/bash
#SBATCH --gres=gpu:2
#SBATCH --job-name anet_train1_seed42
#SBATCH -o anet_train1_seed42_continue.out
#SBATCH -e anet_train1_seed42_continue.err
...
python -m torch.distributed.launch --nproc_per_node=2 --master_port 11402 \
    ...
    --output_dir /home/wiss/zhang/nfs/video_prober/xclip/anet_train1_seed42_continue \
    ...
    --manipulation anet_train1_seed42  \
    --scale 0 \
    --dataset_ckpt anet_train1_seed42 \
